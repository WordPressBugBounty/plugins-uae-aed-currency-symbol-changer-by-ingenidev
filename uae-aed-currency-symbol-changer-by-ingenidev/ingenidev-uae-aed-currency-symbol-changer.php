...
add_action( 'wp_enqueue_scripts', 'ingenidev_uaecsc_enqueue_aed_font_styles' ); // For front-end

// If the symbol also needs to appear in the admin area (e.g., WooCommerce order pages):
add_action( 'admin_enqueue_scripts', 'ingenidev_uaecsc_enqueue_aed_font_styles' );
